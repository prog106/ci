...
class Linker extends CI_Controller {
    ...
    public function signin() {
        ...
        if(!empty($uinfo)) {
            ...
            $sinfo = $this->model->getUserInfo($prm);
            if(!empty($sinfo)) {
                $cv = "t".$sinfo;
    ...
    public function urlsearch() {
        ...
        $list = $this->model->getUrlList($params);
        ...
        $rtn .= "<a href=\"http://ttolo.kr/linker/view/".$params['user']."\">검색 결과 더보기 (".count($list)." 건)</a></pre>";
